...
//             const SnackBar(content: Text('Add booking functionality not implemented yet')),
//           );
//         },
//       ),
//       body: Row(
...
//                 onPressed: () {
//                   Navigator.pushReplacementNamed(context, AppRoutes.bookingsRoute);
//                 },
//               ),
...
//           flex: 2,
//           child: Card(
//             margin: const EdgeInsets.only(left: 24.0, right: 12.0, bottom: 24.0),
//             elevation: 2,
...
//           flex: 3,
//           child: Card(
//             margin: const EdgeInsets.only(left: 12.0, right: 24.0, bottom: 24.0),
//             elevation: 2,
//             shape: RoundedRectangleBorder(
//               borderRadius: BorderRadius.circular(12),
//             ),
